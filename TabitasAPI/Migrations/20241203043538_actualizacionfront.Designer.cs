...
namespace TabitasAPI.Migrations
{
    ...
    [Migration("20241203043538_actualizacionfront")]
    partial class actualizacionfront
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TabitasAPI.Models.Almacen", b =>
                {
                    ...
                    b.ToTable("Almacenes", t =>
                        {
                            t.HasTrigger("trigger_actualizar_proceso_actualtrigger_invoke_set_fecha_editada_on_inserttrg_UpdateFechaEditada");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Bordado", b =>
                {
                    ...
                    b.ToTable("Bordados", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Bordadostrg_UpdateIdProcesoBordadotrg_UpdateFecha_Bordados");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Calidad", b =>
                {
                    ...
                    b.ToTable("Calidades", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Calidadestrg_UpdateIdProcesoCalidadtrg_UpdateFecha_Calidades");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Corte", b =>
                {
                    ...
                    b.ToTable("Cortes", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Cortestrg_UpdateIdProcesoCortetrg_UpdateFecha_Cortes");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.CorteLaser", b =>
                {
                    ...
                    b.ToTable("CorteLaseres", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_CorteLaserestrg_UpdateIdProcesoCorteLasertrg_UpdateFecha_CorteLaseres");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Etiqueta", b =>
                {
                    ...
                    b.ToTable("Etiquetas", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_etiquetastrg_UpdateFecha_Etiquetastrg_UpdateIdProcesoEtiqueta");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Lavado", b =>
                {
                    ...
                    b.ToTable("Lavados", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Lavadostrg_UpdateIdProcesoLavadotrg_UpdateFecha_Lavados");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Maquila", b =>
                {
                    ...
                    b.ToTable("Maquilas", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Maquilastrg_UpdateIdProcesoMaquilatrg_UpdateFecha_Maquilas");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Serigrafia", b =>
                {
                    ...
                    b.ToTable("Serigrafias", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Serigrafiastrg_UpdateIdProcesoSerigrafiatrg_UpdateFecha_Serigrafias");
                        });
            ...
            modelBuilder.Entity("TabitasAPI.Models.Terminado", b =>
                {
                    ...
                    b.ToTable("Terminados", t =>
                        {
                            t.HasTrigger("trigger_invoke_set_fecha_Bordadostrg_UpdateIdProcesoBordadotrg_UpdateFecha_Terminados");
                        });

                    b.HasAnnotation("SqlServer:UseSqlOutputClause", false);
                });

            modelBuilder.Entity("TabitasAPI.Models.Usuarios", b =>
                {
